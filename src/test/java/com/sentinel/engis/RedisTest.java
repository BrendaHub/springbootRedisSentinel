...
//    	vop.set("message", "hello world");
	...
	@Test
	public void firestMapInsert() throws  Exception {
		Long inID = 2L;
		Map<String, String> map = new HashMap<>();
		map.put("name", "loiter");
		map.put("age", "30");
		String tpId = "loiterkey";
		RedisSupplementalId mapID = RedisSupplementalId.builder()
				.id(String.valueOf(inID))
				.tpId(tpId)
//				.mapIds(map)
				.build();
		redisRepository.save(mapID);
